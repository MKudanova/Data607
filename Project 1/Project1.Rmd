...
Finally, the dataset was explicitly ordered by total points and average opponent pre-rating to reflect tournament performance rather than alphabetical ordering, ensuring the output aligns with typical standings interpretation.